...
const EnhancedTripPage: React.FC<TripPageProps> = ({ params }) => {
  ...
  const itineraryStops = [
    ...
    },
    {
      ...
      isEnd: true,
      coordinates: [144.9789, -37.7971] as [number, number],
      details: {
        highlights: [
          "Tour conclusion",
  ...
  const ReviewsContent = () => (
    <div className="space-y-8">
      ...
      <div className="text-center">
        ...
        {/* Achievement Summary */}
        <div className="bg-gray-50 border border-gray-200 rounded-lg p-8 mx-auto max-w-2xl">
      ...
      <div className="max-w-7xl mx-auto px-4 py-8">
        <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="lg:col-span-2">
            {/* Title and Rating */}
            <div className="mb-8 sticky top-16 bg-white z-40 py-4 -mx-4 px-4 border-b border-gray-200">
              ...
              <h1
                className="text-5xl font-medium text-gray-900 pt-6"
                style={{ letterSpacing: "-3%", lineHeight: "60px" }}
              >
                      ...
                      {itineraryStops.map((stop, index) => (
                        ...
                        >
                          <div className="relative flex items-start space-x-4">
                            ...
                            <div
                              className={`relative z-10 flex-shrink-0 w-8 h-8 rounded-full flex items-center justify-center text-sm font-medium transition-all duration-200 ${
                                selectedStop === index
          ...
          <div className="lg:col-span-1">
            ...
            <div className="sticky bottom-0 mt-8 bg-white pt-4">
              <div
                className="space-y-4"
                style={{ fontSize: "13px", fontWeight: 400, color: "#202020" }}
              >
                <div className="flex items-start space-x-4">
                  <CalendarX2
