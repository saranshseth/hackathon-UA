...
export function PopularToursSection() {
  ...
  const prevCard = () => {
    setCurrentIndex(
      (prev) => (prev - 1 + popularTours.length) % popularTours.length
    );
  };
  ...
  if (loading) {
    return (
      <section className="pt-16 md:pt-24 lg:pt-32 pb-12 md:pb-16 lg:pb-[9rem] bg-gradient-to-b from-white to-gray-50">
          ...
          <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 md:mb-12 lg:mb-16">
            <div className="max-w-2xl mb-6 lg:mb-0">
              ...
              <p className="text-lg sm:text-xl text-gray-600 font-light leading-relaxed">
                Join thousands of travelers who have explored the world with our
  ...
  return (
    <section className="relative pt-16 md:pt-24 lg:pt-32 pb-[16rem] md:pb-16 lg:pb-[9rem] bg-gradient-to-b from-white to-gray-50 overflow-hidden z-10">
      <div className="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        {/* Header */}
        <div className="flex flex-col lg:flex-row lg:items-center lg:justify-between mb-8 md:mb-12 lg:mb-16">
          <div className="max-w-2xl mb-6 lg:mb-0">
        ...
        >
          <div
            className={`relative ${
              isMobile ? "w-full max-w-sm mx-auto" : "w-[360px] lg:w-[400px]"
          ...
          >
            {getVisibleCards().map((card, cardIndex) => {
              ...
              const scale = isActive
                ? 1
                : Math.max(0.7, 0.95 - Math.abs(position) * 0.1);
              const opacity = isActive
                ? 1
                : Math.max(0.4, 1 - Math.abs(position) * 0.15);
              const zIndex = isActive
                ? 30
                : Math.max(10, 25 - Math.abs(position) * 3);
...
function PopularTourCard({
  tour,
  featured = false,
}: {
  tour: EnhancedProduct;
  featured?: boolean;
}) {
      ...
      <CardContent className="p-6">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          ...
          <div className="flex items-center gap-2">
            ...
            <span className="text-sm text-gray-600 font-medium">Max 16</span>
          </div>
        </div>
